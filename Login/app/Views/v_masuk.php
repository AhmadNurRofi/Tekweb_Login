    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <ul class="navbar-nav navbar-left">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle beep"><i class="far fa-user"></i></a>
            </a>
            <div class="dropdown-menu dropdown-menu-left">
              <div class="dropdown-title">Profil</div>
