...
<head>
  ...
  <title>Login &mdash; tekweb</title>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="<?= base_url() ?>/template/stisla-master/node_modules/bootstrap-social/bootstrap-social.css">
              ...
              <div class="card-body">
                ...
                ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name = "username" class="form-control" tabindex="1" required>
...
<?php } ?>
            ...
            <div class="mt-5 text-muted text-center">
              Form Login Tekweb Lanjut</a>
            </div>
            <div class="simple-footer text-center">
              Copyright &copy; Ahmad Nur Rofi
            </div>
          </div>
        </div>
      </div>
