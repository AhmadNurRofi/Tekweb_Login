              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Edit Data User pada form di bawah ini</h4>
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="id_user" class="form-control" value="<?= $user->id_user; ?>" disabled>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                        <button type="submit" class="btn btn-primary far fa-edit">  Simpan  </button>
                      </div>
                    </div>
                  </div>
      </form>
